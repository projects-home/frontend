...
import LineProcessVoice from "@/components/echarts/lineProcessVoice.vue";
import clock from "@/components/clock.vue";
import DashBoardVoice from "@/components/echarts/dashBoardVoice.vue";
...
export default {
  ...
  data(){
    return{
      ...
      topBarData:'[{"className":"topBarName","value":"移网后付费语音业务生产作业进程监控"}]',
      ...
      areaLineChartVoiceData:'[{"className":"areaLineChartVoice","legend":["NOO2","NOSI","GLOV","GIOV","GNOV","GBOV"],"text":"话单数近7天对比",'+
      '"xLabel":["9-1","9-2", "9-3", "9-4", "9-5", "9-6", "9-7"],"yName":"单位:万条","color":["#63B8FF","#59D4AA","#69D4AA","#00BAFF","#E0FFFF","#FFA500"],'+
      '"data1":[7, 16, 14, 17, 9, 13, 13],"data2":[8, 6, 14, 13, 2, 14, 12],"data3":[10, 2, 6, 23, 13, 14, 12],"data4":[9, 3, 19, 12, 24, 18, 16],'+
      '"data5":[19, 10, 9, 13, 4, 8, 16],"data6":[22, 8, 9, 10, 14, 18, 16],"boundaryGap":true,"show":false,"max":20,"showSymbol":true}]',
//"legend":["\'NOO2\':false","\'NOSI\':true","\'GLOV\':false","\'GIOV\':false","\'GNOV\':false","\'GBOV\':false"]
      ...
      ',"title":"话单数近3个月对比","className":"barChart2","daysData1":"[17,15,15,10,17,20]","daysData2":"[11,11,15,10,20,10]",' +
      '"daysData3":"[11,15,15,20,25,15]","xLabel":"[\'HOO2\',\'NOSI\',\'GLOV\',\'GIOV\',\'GNOV\',\'GBOV\']","legend":["7月","8月","9月"],'+
      '"unitLeft":"单位:百万条","unitRight":"单位:万条"}]',

     
      barPreprocessData:'[{ "legend":["有效单","重单","错单","无效单"],"daysData1":[13,12,12,12,12,12],'+
      '"daysData2":[3,3,3,4,3,3],"daysData3":[3,3,3,4,3,3],"daysData4":[3,2,2,2,2,2],"className":"barPreprocessVoice",'+
      '"yLabel":["GBOV","GNOV","GIOV","GLOV","NOSI","NOO2"],"unit":"单位:%",'+
      '"proportion":["95%","98%","90%","98%","90%","60%"]}]',
      ...
      ',"width":[15,9]}]',
      dashBoardSmsData6:'[{"className":"dashBoardSms6","value":"100","center":["70%","90%"],"radius":["140%","97%"]'+
      ',"width":[15,9]}]',
