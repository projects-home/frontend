...
export default {
  ...
  props:['lineProcessSmsData'],

  watch:{
    'lineProcessSmsData':function (n,o) {
      var temp = n;
      this.updateData();
    }
  },
  ...
  methods:{
    drawDiagram: function () {
      var attribute = JSON.parse(this.lineProcessSmsData);
...
<style scoped src="../../resource/css/echarts/lineProcessSms.css"></style>
