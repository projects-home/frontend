...
<script>
  export default {
    ...
    props:['dashBoardPreValue'],
    watch:{
      'dashBoardPreValue':function (n,o) {
        var temp = n;
        this.updateData();
      }
    },
    ...
    methods: {
      drawDiagram: function () {
        var attribute = JSON.parse(this.dashBoardPreValue);
...
<style scoped src="../../resource/css/echarts/dashBoardPre.css"></style>
