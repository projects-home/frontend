...
<script>
  export default {
    ...
    props:['dashBoardSmsValue'],
    watch:{
      'dashBoardSmsValue':function (n,o) {
        var temp = n;
        this.updateData();
      }
    },
    ...
    methods: {
      drawDiagram: function () {
        var attribute = JSON.parse(this.dashBoardSmsValue);
...
<style scoped src="../../resource/css/echarts/dashBoardSms.css"></style>
