...
<script>
  export default {
    ...
    props:['lineProcessPreData'],

    watch:{
      'lineProcessPreData':function (n,o) {
        var temp = n;
        this.updateData();
      }
    },
    ...
    methods:{
      drawDiagram: function () {
        var attribute = JSON.parse(this.lineProcessPreData);
...
<style scoped src="../../resource/css/echarts/lineProcessPre.css"></style>
