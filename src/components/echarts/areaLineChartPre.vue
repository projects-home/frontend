<template>
  <div id="areaLineChartPre"></div>
</template>

<script>
export default {
  name:'areaLineChartPre',
  data(){
    return{
      undefined:0
    }
  },
  props:['areaLineChartPreData'],
  watch:{
    'areaLineChartPreData':function (n,o) {
      var temp = n;
  ...
  methods:{
    drawDiagram:function () {
			var _this = this;
      var attribute = JSON.parse(this.areaLineChartPreData);
...
<style scoped src="../../resource/css/echarts/areaLineChartPre.css"></style>
